...
export default class Game extends Component {
  ...
  render() {
    const {
      matchDetails: { utcDate, homeTeam, awayTeam, score, status },
    } = this.props;
    ...
    return (
      <div className="game">
        ...
        <div className="teams-score">
          <div className="home-team inline-b">
            {homeTeam.name}
            <p>abhi ke liye ye likh raha hu</p>
          </div>
          <div className="score inline-b" style={{ background: scoreColor }}>
            {formatScore(score)}
          </div>
          <div className="away-team inline-b">
            {awayTeam.name}
            <p>abhi ke liye fir se ye likh raha hu</p>
          </div>
        </div>
      </div>
    );
